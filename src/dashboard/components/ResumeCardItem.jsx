  ...
  return (
       ...
       <div className=''>
        ...
        items-center justify-center h-[180px] '>
                {/* <Notebook/> */}
                <img src='/cv.webp' width={80} height={80} />
              </div>
        </div>
        </Link>
        <div className='border p-3 flex justify-between  text-white rounded-b-lg shadow-lg bg-blue-700'
         style={{
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction className="bg-red-900" onClick={onDelete} 
            disabled={loading}>
